...
@interface puchViewController : UIViewController
{
...
@property (retain, nonatomic) IBOutlet UILabel *pphoneLabel;
...
@property(nonatomic,retain)NSString *pphonePhoneNumber;
