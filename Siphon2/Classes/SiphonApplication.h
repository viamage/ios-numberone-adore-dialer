...
@property (nonatomic, assign, readonly) FavoritesListController *favoritesListCtrl;
@property (nonatomic, assign, readonly) AccountViewController  *acountviewcontroller;
@property (nonatomic, retain) ContactViewController *contactsViewCtrl;
