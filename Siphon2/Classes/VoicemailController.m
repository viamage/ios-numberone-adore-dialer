 ...
 *  Copy/Users/adoreinfotech/Desktop/new backup/untitled folder/new code for customization for sip client/siphon/Siphon2/Classes/VoicemailController.mright (C) 2008-2010 Samuel <samuelv0304@gmail.com>
 *
...
- (void)viewDidAppear:(BOOL)animated
{
  ...
  UIAlertView *alert = [[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Voicemail", @"VoicemailView") 
                                         ...
                                         otherButtonTitles:NSLocalizedString(@"Ok", @"Adore SIP Client"), nil] autorelease];
